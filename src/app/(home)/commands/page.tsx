      ...
      <div className="space-y-8">
        <div className="space-y-4">
          ...
          <p className="text-muted-foreground text-lg">
            ...
            >
              Valkey
            </a>. You can visit the <a
              href="/versions"
              className="text-primary underline underline-offset-4 hover:text-primary/80"
            >versions</a> page to see which Valkey version your DiceDB release is based on,
            and refer to the corresponding <a
              href="https://valkey.io/commands/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-primary underline underline-offset-4 hover:text-primary/80"
            >
              Valkey&apos;s command reference
            </a> to understand supported commands and their behavior.
          </p>
        </div>

        <p className="text-muted-foreground text-lg">
          In addition to commands that have been <a
